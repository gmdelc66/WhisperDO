...
# -------------------------------------------------------------------------------
#
# Descripción del Script, Script para Generar desde texto Archivos de Audio con Diferentes TLDs (acentos locales)
#
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description=texto_predeterminado)
    parser.add_argument('texto', type=str, nargs='?', default=None, help="Texto a convertir en audio")

    # Parsear los argumentos
    args = parser.parse_args()

    # Texto de ayuda por defecto si no se proporciona ningún argumento

    # Usar el texto proporcionado o el texto por defecto
    texto_a_usar = args.texto if args.texto else texto_predeterminado
